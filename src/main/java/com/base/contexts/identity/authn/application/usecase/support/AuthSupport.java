package com.base.contexts.identity.authn.application.usecase.support;
...
import com.base.contexts.identity.authn.application.usecase.result.AuthMenuItem;
import com.base.contexts.identity.authn.application.usecase.result.AuthMenuTreeNode;
...
public class AuthSupport {
     ...
     * 메뉴 정보는 추후 authr 모듈 정비 시 채워 넣는다.
     */
    public AuthSession buildSession(Long userId, Collection<? extends GrantedAuthority> authorities) {
        ...
        return new AuthSession(
                userSnapshot,
                List.<AuthMenuTreeNode>of(),
                List.<AuthMenuItem>of(),
                permissions
        );
    }
